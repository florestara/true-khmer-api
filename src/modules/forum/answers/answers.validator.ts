...
export const createAnswerValidator = validator(
  "json",
  validateWithSchema(createAnswerSchema),
);

export const updateAnswerValidator = validator(
  "json",
  validateWithSchema(updateAnswerSchema),
);

export const voteAnswerValidator = validator(
  "json",
  validateWithSchema(voteAnswerSchema),
);
