...
CREATE UNIQUE INDEX "volunteer_application_applicant_opportunity_unique_idx" ON "volunteer_application" USING btree ("applicant_id","opportunity_id");--> statement-breakpoint
